      ...
      <div className="hidden md:flex md:w-1/2 bg-linear-to-br from-teal-600 to-teal-800 text-white flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="space-y-6 relative z-10 max-w-md">
          ...
          <h2 className="text-4xl font-extrabold tracking-tight leading-tight">
            Create an Account to Start Scheduling Visits.
          </h2>
          <p className="text-sm text-teal-100/90 leading-relaxed">
            By creating a patient account with City Care, you gain instant
            access to our specialist doctor rosters, digital pathology files,
            and personal prescription history charts.
          </p>

          <div className="pt-4 space-y-3 text-sm text-teal-150">
            <p className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-teal-300" />
              Easy online appointment scheduling desk
            </p>
            <p className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-teal-300" />
              Digital record keeping of diagnosis
            </p>
            <p className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-teal-300" />
              Fast-track outpatient check-ins
            </p>
          </div>
        </div>
        ...
        <div className="text-xs text-teal-200/80 relative z-10">
          Need to return to patient homepage?{" "}
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="space-y-2 text-left">
            ...
            <p className="text-xs text-gray-500">
              Register a free account today to book clinic sessions online.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="e.g. robert.p@gmail.com"
                className="mt-1 w-full bg-gray-50 border border-gray-300/80 rounded-lg p-2.5 text-xs focus:ring-teal-500 focus:bg-white outline-none"
                required
              />
            </div>
