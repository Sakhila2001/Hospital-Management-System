...
export default function DoctorDashboard() {
  ...
  // Active tab: "overview", "appointments"
          ...
          <div>
            <div className="h-16 flex items-center px-6 border-b border-gray-100 gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-teal-650 font-medium -mt-1">Doctor Portal</p>
              </div>
            </div>
          ...
          <div className="p-4 border-t border-gray-100 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 font-medium">{currentDoctor?.specialization}</p>
              </div>
            </div>
        ...
        <main className="flex-1 flex flex-col overflow-y-auto bg-gray-50 relative">
          <header className="h-16 bg-white border-b border-gray-200 px-6 flex items-center justify-between sticky top-0 z-20">
            <h2 className="text-lg font-semibold text-gray-800 capitalize">
              {activeTab === "overview" ? "Practice Overview" : "Assigned Consultations"}
            </h2>
