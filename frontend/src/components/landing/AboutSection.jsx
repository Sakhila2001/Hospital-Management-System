        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              Founded on the pillars of compassionate medical care and
              scientific diligence, City Care Hospital provides comprehensive,
              integrated therapies under a single roof. Our primary goal is
              supporting speedy recovery and clinical precision.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md space-y-4">
            ...
            <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
              ...
              for deploying state-of-the-art diagnostic facilities and ensuring
              empathy-led treatment guidelines.
            </p>
