      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 pb-24 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-left space-y-6">
          ...
          <p className="text-base sm:text-lg text-gray-600 leading-relaxed max-w-lg">
            Welcome to City Care Hospital. We bring together dedicated medical
            experts, advanced treatment facilities, and round-the-clock clinical
            support to keep you and your family healthy.
          </p>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden p-6 space-y-6 relative">
            <h3 className="text-lg font-bold text-gray-900">
              Hospital Check-in Guidelines
            </h3>

            <div className="space-y-4">
              <div className="flex gap-4">
                <div className="h-8 w-8 rounded-full bg-teal-50 text-teal-600 flex items-center justify-center font-bold shrink-0">
                  1
                </div>
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Choose from our list of available specialists in Cardiology,
                    Pediatrics, or General Medicine.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Select a morning or evening clinic session that matches your
                    schedule.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Receive your patient booking code instantly. Present it at
                    the reception counter upon arrival.
                  </p>
                </div>
              </div>
            </div>
